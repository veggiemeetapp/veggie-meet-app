...
const HIDDEN_NAV_PATTERNS = [/^\/meetup\//, /^\/join\//, /^\/group\//, /^\/chat\//, /^\/dm\//, /^\/meetup-created\//, /^\/onboarding/, /^\/auth\/callback/, /^\/you\/edit/, /^\/checkin\//, /^\/veggie\//, /^\/notifications/, /^\/settings/, /^\/owner\//, /^\/\.lovable\/oauth\//];
