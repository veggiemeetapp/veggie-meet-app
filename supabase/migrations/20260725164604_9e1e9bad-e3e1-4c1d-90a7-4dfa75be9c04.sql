...
BEGIN
  ...
  IF meaningful THEN
    ...
    SELECT a.profile_id, me, 'meetup_updated'::notification_type,
      'meetup', _meetup_id, 'meetup', _meetup_id, NULL,
      'Location updated for ' || COALESCE(m.title,'a Meetup') || '.',
      jsonb_build_object('meetup_id', _meetup_id, 'change_id', change_id,
  ...
  RETURN jsonb_build_object('meetup_id', _meetup_id, 'change_id', change_id,
