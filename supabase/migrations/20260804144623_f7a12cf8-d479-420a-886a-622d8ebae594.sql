-- WO-059A QA fix: relocations over 1 km require explicit owner acknowledgement.
CREATE OR REPLACE FUNCTION public.complete_community_place_identity_review(
  _place_id uuid, _case_type text, _result text,
  _proposed_google_place_id text DEFAULT NULL::text,
  _proposed_name text DEFAULT NULL::text,
  _proposed_address text DEFAULT NULL::text,
  _proposed_neighborhood text DEFAULT NULL::text,
  _proposed_latitude double precision DEFAULT NULL::double precision,
  _proposed_longitude double precision DEFAULT NULL::double precision,
  _proposed_maps_url text DEFAULT NULL::text,
  _proposed_website_url text DEFAULT NULL::text,
  _official_source_url text DEFAULT NULL::text,
  _evidence_summary text DEFAULT NULL::text,
  _owner_note text DEFAULT NULL::text,
...
REVOKE ALL ON FUNCTION public.complete_community_place_identity_review(
  ...
  boolean, boolean, boolean, boolean, boolean, uuid, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.complete_community_place_identity_review(
  uuid, text, text, text, text, text, text, double precision, double precision,
  text, text, text, text, text, boolean, boolean, boolean, boolean, boolean,
  boolean, boolean, boolean, boolean, boolean, uuid, uuid) TO authenticated, service_role;