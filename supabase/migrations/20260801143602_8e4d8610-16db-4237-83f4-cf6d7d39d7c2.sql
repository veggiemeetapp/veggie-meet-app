...
REVOKE ALL ON FUNCTION public.get_my_supported_places() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_my_supported_places() FROM anon;
GRANT EXECUTE ON FUNCTION public.get_my_supported_places() TO authenticated;